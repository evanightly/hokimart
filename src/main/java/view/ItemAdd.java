...
public class ItemAdd extends javax.swing.JDialog {
     ...
     */
    public ItemAdd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            DefaultComboBoxModel cbItems = new DefaultComboBoxModel(categoryStrings.toArray());
            category.setModel(cbItems);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        try {
            ...
            int id_category = categorySourceData.get(this.category.getSelectedIndex()).getId_category();
            ...
            ItemController.add(title, description, id_category, price, in_stock);
            this.dispose();
        } catch (SQLException ex) {
            Logger.getLogger(ItemAdd.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ItemAdd dialog = new ItemAdd(new javax.swing.JFrame(), true);
